...
<a href="index.html"><img src="img/logo1.png" alt="" style="
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            ...
            <h1 class="text-warning font-monospace text-center my-3">Beauty and Wellness</h1>
<?php
include'login/config.php';
$sql = "SELECT * FROM products where category = 'Beauty and Wellness' "; // Changed table name to "Products"
