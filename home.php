...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/img2.jpg" class="d-block w-100" alt="First slide">
      
      <a href="login/carbonfootprint.php" class="carousel-button btn btn-primary btn-lg">carbon footprint calculator</a>
    </div>
    <div class="carousel-item">
      <img src="img/image2.jpg" class="d-block w-100" alt="Second slide">
      
      <a href="login/carbonfootprint.php" class="carousel-button btn btn-primary btn-lg">carbon footprint calculator</a>
    </div>
    <div class="carousel-item">
      <img src="img/image3.png" class="d-block w-100" alt="Third slide">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="next">
    ...
    <section class="product-categories">
        ...
        <ul>
            ...
            <li><a href="shop.php">Home essential</a></li>
